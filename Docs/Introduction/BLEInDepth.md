...
<span class="images">![Server and client](../Introduction/Images/clientserver.png)<span>The mbed board is the server or peripheral; the phones are the clients and central devices")</span></span>
...
<span class="images">![Connected and advertising](../Introduction/Images/ConnModes.png)<span>Advertising mode is one-to-many, whereas connected mode is one-to-one</span></span>

Advertisements are very limited in size. The general GAP broadcast's data breakdown is illustrated in this diagram:

<span class="images">![](../Advanced/Images/GAP/GeneralStruct.png)<span>The BLE stack eats part of our package's 47B, until only 26B are available for our data</span></span>
...
1. The PDU's advertising data field has 31 bytes left, divided into advertising data (AD) structures. Then:
...
<span class="tips">If you want to see an example of ADs, see our extended explanation in the [Custom GAP Advertising section](../Advanced/CustomGAP.md).</span>
...
<span class="notes">**Note:** the latest Bluetooth standard allows advertisements to continue in parallel with connections, and this will become a part of mbed's BLE_API before the end of 2015.</span>
...
<span class="images">![breakdown](../Advanced/Images/Service.png)<span> "A single service can contain several characteristics")</span></span>
...
<span class="images">![breakdown](../Advanced/Images/heart_rate_profile.png)<span>An example profile with two services")</span></span>
...
<span class="images">![](../Advanced/Images/DeviceInformationService.png)</span>
...
<span class="tips">For a full walkthrough of characteristic creation on mbed, see our [input service template](../Advanced/InputButton.md#the-button-state-characteristic).</span>
...
1. The **value** is the “interesting” part of the characteristic: it’s the value that contains the data you’re viewing and reacting to.

1. The **descriptor** is not mandatory; you can use it to provide more information about a characteristic or to control its behaviour. For example, descriptors are used when working with notifications.
...
<span class="tips">For information about creating a read/write characteristic on mbed, see our [actuator service template](../Advanced/LEDReadWrite.md#the-led-state-characteristic).</span>
...
<span class="images">![breakdown](../Advanced/Images/BLE_Profile_Breakdown.png)<span>A single profile can contains several services, and each of the services can contain several characteristics")</span></span>
