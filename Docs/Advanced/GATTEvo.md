...
<span class="tips">Get the code [here](http://developer.mbed.org/teams/Bluetooth-Low-Energy/code/BLE_GATT_Example/).</span>
...
<span class="tips">You can see an example of setting up an input service on our [YouTube channel](https://www.youtube.com/watch?v=YaLG-6pDFrw).</span>
...
<span class="images">![](../Advanced/Images/BLE_Profile_Breakdown.png)</span>
...
<span class="notes">**Note:** If you change ``DEVICE_NAME`` here you will also need to change it in the subsequent Evothings application **app.js** (which will be covered [later](../Advanced/GATTEvo.md#interacting-with-the-gatt-service-evothings)).</span>
...
<span class="images">![](../Advanced/Images/Evothings/EvothingsRun.png)</span>
...
<span class="images">![](../Advanced/Images/Evothings/EvothingsToggleButton.png)</span>

<span class="images">![](../Advanced/Images/Evothings/EvothingsLEDOn.png)</span>
