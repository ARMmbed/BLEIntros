...
<span style="background-color:lightblue; color:gray; display:block; height:100%; padding:10px;">*The BLE stack eats part of our package's 47B, so only 26B are available for our data*</span>
...
2. Download the [custom made app](https://github.com/BlackstoneEngineering/evothings-examples/tree/development/experiments/mbed-Evothings-CustomGAP).

3. Drag-and-drop the **index.html** file from the app's directory into the Evothings Workbench on your computer.
